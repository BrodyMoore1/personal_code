...
grocery_gas_budget <- tribble(
  ...
  # July 29 
  "twisted_sugar",     11.97, "restaurant",
  "tj_maxx",           36.61, "clothes",
  "walmart",           63.03, "misc",
  "old_navy",          81.27, "new_baby",
  "locals",            17.11, "new_baby",
  "chick_fila",        17.38, "restaurant",
  "walmart",           25.94, "gas",
  "pro_image_sport",   32.16, "new_baby",
  "slc_golf",          18.00, "golf",
...
```{r Month Comparison}
fluidRow(
  column(6, wrap_up_reactable(aug_purchases)),
  column(6, wrap_up_reactable(sep_purchases))
)
