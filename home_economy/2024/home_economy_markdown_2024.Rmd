...
may_purchases <- tribble(
  ...
  "walmart",                 3.00, "grocery",
  "walmart",                 7.15, "house_var",
  "adobe",                  10.69, "subscription",
  ...
  "recreation_registration",35.00, "misc",
  "karie_annes",             9.56, "restaurant",
  "walmart",                 5.32, "misc",
  "walmart",                33.84, "misc",
  "home_depot",            129.40, "house_var",
  "sams_club",              39.01, "misc",
...
fluidRow(
  ...
  column(6, wrap_up_reactable(apr_purchases))
)
