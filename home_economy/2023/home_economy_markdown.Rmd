...
jan_purchases <- tribble(
  ...
  "dmv",           141.00,   "car",
  "panda_express",          20.84,   "restaurant",
  "walmart",        18.86,   "misc",
  ...
  "amazon",         31.01,   "baby",
  "walmart",        11.97,   "misc",
  "mandarin_garden",        38.53,   "restaurant",
  "crumbl",         13.76,   "restaurant",
  "adobe",          10.69,   "subscription",
  "logans_heroes",     17.51,   "restaurant",
  "ginnys_pit_stop",          6.43,   "restaurant",
  ...
  "keva_juice",           11.99,   "restaurant",
  "dominion",     21.89,   "house_essential",
  ...
  "venmo",         870.00,   "baby",
  "dominion",     20.08,   "house_essential",
  "allstate",       12.39,   "house_essential",
  "nibley_city",      78.02,   "house_essential",
...
feb_purchases <- tribble(
  ...
  "cafe_zupas",         28.06,   "restaurant",
  "logans_heroes",    15.00,   "restaurant",
  "great_harvest",  5.71,   "restaurant",
  "fizz_n_fryz",   6.47,   "restaurant",
  "amazon",        16.08,   "misc",
  "walmart",       71.26,   "misc",
  "maverik",       31.02,   "gas",
  "maceys",        14.49,   "grocery",
  "logans_heroes",    41.99,   "restaurant",
  "dmv",           23.00,   "car",
  ...
  "maverik",       20.63,   "gas",
  "maverik",       19.50,   "gas",
  "ginnys_pit_stop",         10.98,   "restaurant",
  "roku",          11.78,   "subscription",
  "maceys",         5.34,   "grocery",
  "fizz_n_fryz",   9.97,   "restaurant",
  ...
  "logans_heroes",    17.25,   "restaurant",
...
april_purchases <- tribble(
  ...
  "chick_fila",       26.30, "vacation_cali",
...
may_purchases <- tribble(
  ...
  "logans_heroes",     10.00, "restaurant",
...
june_purchases <- tribble(
  ...
  "ginnys_pit_stop_pit_stop",  14.34, "restaurant",
...
july_purchases <- tribble(
  ...
  "logans_heroes",     16.49, "restaurant",
...
august_purchases <- tribble(
  ...
  "venmo",          -50.00, "grocery",
  "taco_time",         3.78, "restaurant",
  "roku",            11.78, "subscription",
  "old_navy",        19.19, "baby",
  "cafe_zupas",            6.38, "restaurant",
...
october_purchases <- tribble(
  ...
  "logans_heroes",     43.49, "restaurant",
  "claires",          35.30, "personal",
  "apple",             7.50, "subscription",
  "sams_club",       146.08, "personal",
  "sams_club",         6.97, "restaurant",
  "ginnys_pit_stop_pit_stop",            9.72, "restaurant",
  "maverik",          44.65, "gas",
  ...
  "7_eleven",      1.81, "restaurant",
  "maverik",          46.25, "gas",
  "bowmans_ad",       35.96, "church",
  "betos",             8.97, "restaurant",
  "apple",            11.79, "subscription",
  "cafe_zupas",            15.14, "restaurant",
...
november_purchases <- tribble(
  ...
  "maverik",          39.76, "gas",
  "jamba_juice",            15.86, "restaurant",
  "panda_express",            15.98, "restaurant",
  ...
  "walmart",          17.06, "misc",
  "panda_express",            16.42, "restaurant",
  ...
  "ginnys_pit_stop",            8.04, "restaurant",
  "chouchou",         14.50, "restaurant",
  "walmart",          11.30, "personal",
  "walmart",          10.00, "baby",
  "old_grist_mill",        12.29, "restaurant",
  "maverik",          34.53, "gas",
  "usa_tech",          1.75, "car",
  ...
  "roku",             15.01, "subscription",
  "cafe_zupas",            13.49, "restaurant",
  "costa_vida",       19.46, "restaurant",
  "home_depot",     -245.03, "house_var",
  "maverik",          41.30, "gas",
  "maverik",           7.69, "restaurant",
  "cinemark",          8.31, "family",
  "apple",             2.99, "subscription",
  "quick_quack",      41.99, "subscription",
  "verizon",          88.46, "christmas",
  "maverik",           5.44, "restaurant",
  "buckle",           75.06, "clothes",
  "sticky_bird",      11.10, "restaurant",
  "sams_club",        53.63, "subscription",
  "hatch_chocolate",  16.87, "restaurant",
  "pretty_bird",      37.52, "restaurant",
  "apple",            11.79, "subscription",
  "7_eleven",     25.12, "gas",
  "7_eleven",      1.81, "restaurant",
  "interval",        229.00, "vacation_san_antonio",
  "target",          203.76, "black_friday",
  "target",           41.81, "black_friday",
  "amazon",           13.92, "black_friday",
  "simplemodern",     21.02, "black_friday",
  "columbia",        106.99, "black_friday",
  "amazon",          115.55, "black_friday",
  "ulta",            128.12, "black_friday",
  "ulta",            117.69, "black_friday",
  "tubby_todd",       77.88, "black_friday",
  "thread_wallet",    52.98, "black_friday",
  "kyte_baby",        94.12, "black_friday",
  "lowes",           212.93, "black_friday",
  "target",           42.79, "black_friday",
  "target",          146.18, "black_friday",
  "thai_house",       27.97, "restaurant",
  "allstate",         11.50, "house_essential",
  "southwest",       345.18, "vacation_san_antonio",
  "costa_vida",        8.09, "restaurant",
  #
  "trader_joes",      55.49, "grocery",
  "target",           53.56, "personal",
  "san_diablo",       16.00, "restaurant",
  "harmons",          20.70, "restaurant",
  "walmart",           5.11, "misc",
  "walmart",          39.22, "misc",
  "ulta",            125.71, "personal",
  #"sams_club",       139.86, "misc",
  "sams_club",       102.46, "baby",
  "sams_club",        37.40, "grocery",
  "brutus_loan",     340.00, "car"
) %>% 
  mutate(month = "nov")
...
december_purchases <- tribble(
  ~place,           ~amount, ~category,
  "panda_express",    16.42, "restaurant",
  "maverik",          32.21, "gas",
  "lees",             10.00, "grocery",
  "lees",              5.93, "christmas",
  "dominos",          15.00, "christmas",
  "twisted_sugar",     5.55, "restaurant",
  "super_chix",       23.19, "restaurant",
  "sierra",           94.11, "christmas",
  "ross",             34.00, "baby",
  "ross",              5.55, "clothes",
  "walmart",          20.73, "misc",
  "noom",            245.67, "personal_development",
  "noom",           -245.67, "personal_development",
  "sonic",             7.52, "restaurant",
  "amazon",           28.95, "clothes",
  "amazon",           16.08, "misc",
  "sams_club",        67.50, "christmas",
  "chick_fila",        5.56, "restaurant",
  "costco",           26.74, "christmas",
  #"costco",           55.61, "misc",
  "costco",           13.99, "grocery",
  "costco",           14.99, "house_var",
  "costco",           26.63, "christmas",
  "costco",           15.83, "restaurant",
  "dominion",         51.63, "house_essential",
  #"costco",           86.14, "misc"
  "costco",           46.25, "grocery",
  "costco",           39.89, "house_var",
  # New update
  "delta",            136.30, "vacation_carolina",
  "delta",            286.30, "vacation_carolina",
  "westside_coffee",   18.85, "restaurant",
  "locals",            30.00, "mom_bday",
  "locals",            12.78, "christmas",
  "in_n_out",          15.44, "restaurant",
  "interval",         198.00, "vacation_carolina",
  "maverik",           32.10, "gas",
  "walmart",           44.85, "barbie_party",
  "maceys",             7.40, "barbie_party",
  "in_n_out",           7.88, "restaurant",
  "homegoods",         74.00, "barbie_party",
  "hobby_lobby",       42.16, "barbie_party",
  "twisted_sugar",     16.20, "barbie_party",
  "taco_bell",          8.60, "restaurant",
  "krispy_kreme",      15.48, "barbie_party",
  "dominos",           34.52, "barbie_party",
  "amazon",            75.08, "baby",
  "walmart",           13.34, "personal",
  "eagle_creek",      202.24, "christmas",
  "sonic",              3.22, "restaurant",
  "arbys",              3.55, "restaurant",
  "trader_joes",       56.99, "grocery",
  "jersey_mikes",      10.51, "restaurant",
  "homegoods",         10.70, "house_var",
  "la_hacienda",       16.00, "restaurant",
  "tj_maxx",           32.15, "clothes",
  "adobe",             10.69, "subscription",
  "cafe_zupas",             13.52, "restaurant",
  "target",            40.13, "baby",
  "crown_burger",     15.57, "restaurant",
  "hometown_apparel",  85.62, "clothes",
  "skewered_thai",    100.00, "mom_bday",
  "maverik",           34.35, "gas",
  "maverik",            2.13, "restaurant",
  "hatch_chocolate",   17.42, "restaurant",
  "sams_club",         56.63, "baby",
  "mcdonalds",         27.44, "becks_kids",
  "hires_big_h",       41.58, "becks_kids",
  "apple",              7.50, "subscription",
  "starbucks",         10.00, "jessi_bday",
  "panda_express",     32.04, "becks_kids",
  "trader_joes",       49.03, "christmas",
  "mortgage",         3487.68, "house_payment",
  "hoa",               60.00, "house_essential",
  "costco",            13.97, "barbie_party",
  "becks_kids",      -150.00, "becks_kids",
  "krystal",          116.00, "subscription",
  "old_grist_mill",    12.29, "restaurant",
  "tubby_todd",        81.33, "baby",
  "tubby_todd",         5.99, "baby",
  "great_harvest",     18.23, "restaurant",
  "gnc",               18.53, "personal",
  "amazon",            36.93, "christmas",
  "amazon",            28.95, "christmas",
  "maverik",           30.11, "gas",
  "in_n_out",           9.67, "restaurant",
  "arbys",              3.77, "restaurant",
  "sierra",            21.39, "clothes",
  "old_navy",          16.04, "baby",
  "cafe_zupas",        13.49, "restaurant",
  "locals",            27.80, "christmas",
  "amazon",            20.32, "christmas",
  "sams_club",        165.05, "baby",
  "sams_club",          7.38, "restaurant",
  "roku",              15.01, "subscription",
  "maverik",            5.32, "restaurant",
  "maverik",           21.49, "gas",
  "amazon",            55.86, "house_var",
  "target",            56.48, "christmas",
  "target",            61.07, "christmas",
  "hug_hes",           16.60, "restaurant",
  "amazon",            10.71, "christmas",
  "sams_club",         58.47, "christmas",
  "walmart",           23.53, "baby",
  "quick_quack",       41.99, "subscription",
  "apple",              2.99, "subscription",
  "quilted_bear",      30.82, "christmas",
  "in_n_out",          16.02, "restaurant",
  "maverik",           25.32, "gas",
  "maverik",            3.70, "restaurant",
  "quantum_fiber",     75.00, "house_essential",
  "allstate",          11.50, "house_essential",
  "costco",            33.99, "personal",
  "downeast",          30.82, "clothes",
  "planet_fitness",    10.70, "personal_development",
  "rocky_mtn",         44.15, "house_essential",
  "nibley_city",      107.49, "house_essential",
  "walmart",           30.17, "house_var",
  "hiking",           113.25, "hobby",
  "greek_streak",      25.06, "restaurant",
  "sonic",              3.22, "restaurant",
  "maverik",           30.08, "gas",
  "rainbow_gardens",    4.52, "restaurant",
  "greenery_rest",     14.72, "restaurant",
  "renewal",          121.25, "car",
  "dominos",           19.43, "restaurant",
  "student_loan",     336.10, "debt",
  "winco",              8.16, "grocery",
  "sonic",              3.22, "restaurant",
  "sams_club",        213.99, "chirstmas",
  "logans_heroes",     19.74, "restaurant",
  "westside_coffee",   27.76, "restaurant",
  "natural_grocers",    9.79, "grocery",
  "panda_express",     27.06, "restaurant",
  "maverik",           35.19, "gas"
) %>% 
  mutate(month = "dec")

december_breakdown <- breakdown_function(december_purchases)

december_categories <- category_function(december_purchases, "december")
...
```{r Black Friday Def}
black_friday_df <- tribble(
  ~place,           ~amount, ~category,
  "target",          203.76, "christmas",
  "target",           41.81, "hobby",
  "amazon",           13.92, "baby",
  "simplemodern",     21.02, "personal",
  "columbia",        106.99, "clothes",
  "amazon",          115.55, "baby",
  "ulta",            128.12, "personal",
  "ulta",            117.69, "personal",
  "tubby_todd",       77.88, "baby",
  "thread_wallet",    52.98, "christmas",
  "kyte_baby",        94.12, "baby",
  "lowes",           212.93, "house_var",
  "target",           42.79, "personal",
  #"target",          146.18, "black_friday",
  "target",           50.00, "personal",
  "target",           55.00, "family",
  "target",           41.18, "baby"
)
```
...
already_paid_san_antonio <- all_months_stacked %>% 
  filter(category == "vacation_san_antonio") %>% 
  select(place, amount) %>% 
  mutate(paid = TRUE)

planned_san_antonio <- tribble(
  ~place,      ~amount, ~paid,
  "rental_car", 456.70, FALSE,
)

full_san_antonio <- already_paid_san_antonio %>% 
  bind_rows(planned_san_antonio)
...
yearly_reactable <- categories_together_cleaned %>% 
  ...
  reactable(
    ...
    columns = list(
      ...
      December  = colDef(format = colFormat(currency = "USD"), footer = function(values) sprintf("$%.2f", sum(values)))
    )
  )
```
...
fluidRow(
  ...
  column(6, wrap_up_reactable(december_purchases))
)
